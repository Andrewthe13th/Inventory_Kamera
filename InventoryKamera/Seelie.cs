...
namespace InventoryKamera
{
	internal class Seelie
	{
		...
		internal void WriteToJSON(string outputDirectory, string oldDataFilePath = "")
		{
			...
			string fileName = "\\genshinData_SEELIE_" + DateTime.Now.ToString("yyyy.MM.dd_HH.mm") + ".json";
			fileName.Replace('/', '_');
			...
			{
				UserInterface.AddError($"Failed to output Seelie to : {outputDirectory}");
			}
		}

		private void WriteStringToFile(string dataString, string outputFile)
		{
