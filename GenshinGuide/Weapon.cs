...
namespace GenshinGuide
{
	public class Weapon
	{
		...
		public Weapon(string _name, int _level, bool _ascension, int _refinementLevel, string _equippedCharacter = null, int _id = 0)
		{
			name = _name;
			level = _level;
		...
		public bool IsValid()
		{
			return Scraper.IsValidWeapon(name) && level != -1 && refinementLevel != -1;
		}
